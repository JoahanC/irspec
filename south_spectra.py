...
spec_obj = CubeSpec("./../", "param_files", "IR23128-S_1_single_param.txt", "input_data/IR23128-S/", redshift=0.044601, fit_dirname="IR23128S_AGN1", mode="AGN")
af = spec_obj.open_asdf()
wave = np.asarray(af.tree['cafefit']['obsspec']['wave'])
flux = np.asarray(af['cafefit']['obsspec']['flux'])
flux_unc = np.asarray(af['cafefit']['obsspec']['flux_unc'])
...
spec_obj = CubeSpec("./../", "param_files", "IR23128-S_2_single_param.txt", "input_data/IR23128-S/", redshift=0.044601, fit_dirname="IR23128S_AGN2", mode="AGN")
af = spec_obj.open_asdf()
wave = np.asarray(af.tree['cafefit']['obsspec']['wave'])
flux = np.asarray(af['cafefit']['obsspec']['flux'])
flux_unc = np.asarray(af['cafefit']['obsspec']['flux_unc'])
...
spec_obj = CubeSpec("./../", "param_files", "IR23128-S_3_single_param.txt", "input_data/IR23128-S/", redshift=0.044601, fit_dirname="IR23128S_AGN3", mode="AGN")
af = spec_obj.open_asdf()
wave = np.asarray(af.tree['cafefit']['obsspec']['wave'])
flux = np.asarray(af['cafefit']['obsspec']['flux'])
flux_unc = np.asarray(af['cafefit']['obsspec']['flux_unc'])
...
spec_obj = CubeSpec("./../", "param_files", "IR23128-S_4_single_param.txt", "input_data/IR23128-S/", redshift=0.044601, fit_dirname="IR23128S_AGN4", mode="AGN")
af = spec_obj.open_asdf()
wave = np.asarray(af.tree['cafefit']['obsspec']['wave'])
flux = np.asarray(af['cafefit']['obsspec']['flux'])
flux_unc = np.asarray(af['cafefit']['obsspec']['flux_unc'])
...
flux_unc = np.asarray(af['cafefit']['obsspec']['flux_unc'])
name6 = "IR 23128-S 5"
spec_dict[name6] = {'wave':wave, 'flux':flux, 'flux_unc':flux_unc}
coords[name6] = (spec_obj.param_dict["user_ra"], spec_obj.param_dict["user_dec"], spec_obj.param_dict["user_r_ap"])

scaling = [1, 10, 100, 1000, 10000, 1e5]
...
names = ["IR23128Sr0.5", "IR23128Sr0.75", "IR23128Sr1.0", "IR23128Sr1.25", "IR23128Sr1.5", "IR23128Sr1.7"]
...
plt.savefig("ir23128s_spectra.pdf", dpi=1000)
