...
spec_obj = CubeSpec("./../", "param_files", "IR23128-N_13_single_param.txt", "input_data/IR23128-N/", redshift=0.044601, fit_dirname="IR23128N_SB13", mode="SB")
spec_obj.perform_single_extraction_custom()
#spec_obj.perform_fit()
#spec_obj.recall_line()

#spec_obj = CubeSpec("./../", "param_files", "IR23128-N_9_single_param.txt", "input_data/IR23128-N/", redshift=0.044601, fit_dirname="IR23128N_SB9", mode="SB")
