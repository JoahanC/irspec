...
spec_obj = CubeSpec("./../", "param_files", "IR23128-N_5_single_param.txt", "input_data/IR23128-N/", redshift=0.044601, fit_dirname="IR23128N_SB5", mode="SB")
af = spec_obj.open_asdf()
wave = np.asarray(af.tree['cafefit']['obsspec']['wave'])
flux = np.asarray(af['cafefit']['obsspec']['flux'])
flux_unc = np.asarray(af['cafefit']['obsspec']['flux_unc'])
...
spec_obj = CubeSpec("./../", "param_files", "IR23128-N_10_single_param.txt", "input_data/IR23128-N/", redshift=0.044601, fit_dirname="IR23128N_SB10", mode="SB")
af = spec_obj.open_asdf()
wave = np.asarray(af.tree['cafefit']['obsspec']['wave'])
flux = np.asarray(af['cafefit']['obsspec']['flux'])
flux_unc = np.asarray(af['cafefit']['obsspec']['flux_unc'])
...
spec_obj = CubeSpec("./../", "param_files", "IR23128-N_11_single_param.txt", "input_data/IR23128-N/", redshift=0.044601, fit_dirname="IR23128N_SB11", mode="SB")
af = spec_obj.open_asdf()
wave = np.asarray(af.tree['cafefit']['obsspec']['wave'])
flux = np.asarray(af['cafefit']['obsspec']['flux'])
flux_unc = np.asarray(af['cafefit']['obsspec']['flux_unc'])
...
flux_unc = np.asarray(af['cafefit']['obsspec']['flux_unc'])
name7 = "IR 23128-N 8"
spec_dict[name7] = {'wave':wave, 'flux':flux, 'flux_unc':flux_unc}
coords[name7] = (spec_obj.param_dict["user_ra"], spec_obj.param_dict["user_dec"], spec_obj.param_dict["user_r_ap"])
...
plt.savefig("ir23128n_spectra.pdf", dpi=1000)