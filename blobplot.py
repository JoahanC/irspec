...
for goal in goals_sample:
    ...
    ne2_fluxes.append(goals_sample[goal][1])
    ne5_fluxes.append(goals_sample[goal][2])
    ne3_fluxes.append(goals_sample[goal][3])
...
ir23128n0_line_path = "./../cafe_output/IR23128-N/0/IR23128N_SB0/IR23128-N_SingleExt_r03as/IR23128-N_SingleExt_r03as_linetable.ecsv"
ir23128n1_line_path = "./../cafe_output/IR23128-N/1/IR23128N_SB1/IR23128-N_SingleExt_r03as/IR23128-N_SingleExt_r03as_linetable.ecsv"
ir23128n2_line_path = "./../cafe_output/IR23128-N/2/IR23128N_SB2/IR23128-N_SingleExt_r03as/IR23128-N_SingleExt_r03as_linetable.ecsv"

ir23128n0_line_table = Table.read(ir23128n0_line_path, format='ascii.ecsv')
ir23128n1_line_table = Table.read(ir23128n1_line_path, format='ascii.ecsv')
ir23128n2_line_table = Table.read(ir23128n2_line_path, format='ascii.ecsv')

# ir23128n0
ir23128n0_narrow_s4_idx = np.argwhere(ir23128n0_line_table["line_name"] == "SIV_105105N")[0][0]
ir23128n0_broad_s4_idx = np.argwhere(ir23128n0_line_table["line_name"] == "SIV_105105B")[0][0]
ir23128n0_ne2_idx = np.argwhere(ir23128n0_line_table["line_name"] == "NeII_128136N")[0][0]
ir23128n0_narrow_ne3_idx = np.argwhere(ir23128n0_line_table["line_name"] == "NeIII_155551N")[0][0]
ir23128n0_broad_ne3_idx = np.argwhere(ir23128n0_line_table["line_name"] == "NeIII_155551B")[0][0]

ir23128n0_s4_flux = ir23128n0_line_table["line_strength_int"][ir23128n0_broad_s4_idx] + ir23128n0_line_table["line_strength_int"][ir23128n0_narrow_s4_idx]
ir23128n0_s4_flux_err = np.sqrt(ir23128n0_line_table["line_strength_int_unc"][ir23128n0_broad_s4_idx] ** 2 + ir23128n0_line_table["line_strength_int_unc"][ir23128n0_narrow_s4_idx] ** 2)
ir23128n0_ne2_flux = ir23128n0_line_table["line_strength_int"][ir23128n0_ne2_idx]
ir23128n0_ne2_flux_err = ir23128n0_line_table["line_strength_int_unc"][ir23128n0_ne2_idx]
ir23128n0_ne3_flux = ir23128n0_line_table["line_strength_int"][ir23128n0_broad_ne3_idx] + ir23128n0_line_table["line_strength_int"][ir23128n0_narrow_ne3_idx]
ir23128n0_ne3_flux_err = np.sqrt(ir23128n0_line_table["line_strength_int_unc"][ir23128n0_broad_ne3_idx] ** 2 + ir23128n0_line_table["line_strength_int_unc"][ir23128n0_narrow_ne3_idx] ** 2)

# ir23128n1
ir23128n1_narrow_s4_idx = np.argwhere(ir23128n1_line_table["line_name"] == "SIV_105105N")[0][0]
ir23128n1_broad_s4_idx = np.argwhere(ir23128n1_line_table["line_name"] == "SIV_105105B")[0][0]
ir23128n1_ne2_idx = np.argwhere(ir23128n1_line_table["line_name"] == "NeII_128136N")[0][0]
ir23128n1_narrow_ne3_idx = np.argwhere(ir23128n1_line_table["line_name"] == "NeIII_155551N")[0][0]
ir23128n1_broad_ne3_idx = np.argwhere(ir23128n1_line_table["line_name"] == "NeIII_155551B")[0][0]

ir23128n1_s4_flux = ir23128n1_line_table["line_strength_int"][ir23128n1_broad_s4_idx] + ir23128n1_line_table["line_strength_int"][ir23128n1_narrow_s4_idx]
ir23128n1_s4_flux_err = np.sqrt(ir23128n1_line_table["line_strength_int_unc"][ir23128n1_broad_s4_idx] ** 2 + ir23128n1_line_table["line_strength_int_unc"][ir23128n1_narrow_s4_idx] ** 2)
ir23128n1_ne2_flux = ir23128n1_line_table["line_strength_int"][ir23128n1_ne2_idx]
ir23128n1_ne2_flux_err = ir23128n1_line_table["line_strength_int_unc"][ir23128n1_ne2_idx]
ir23128n1_ne3_flux = ir23128n1_line_table["line_strength_int"][ir23128n1_broad_ne3_idx] + ir23128n1_line_table["line_strength_int"][ir23128n1_narrow_ne3_idx]
ir23128n1_ne3_flux_err = np.sqrt(ir23128n1_line_table["line_strength_int_unc"][ir23128n1_broad_ne3_idx] ** 2 + ir23128n1_line_table["line_strength_int_unc"][ir23128n1_narrow_ne3_idx] ** 2)

# ir23128n2
ir23128n2_narrow_s4_idx = np.argwhere(ir23128n2_line_table["line_name"] == "SIV_105105N")[0][0]
ir23128n2_broad_s4_idx = np.argwhere(ir23128n2_line_table["line_name"] == "SIV_105105B")[0][0]
ir23128n2_ne2_idx = np.argwhere(ir23128n2_line_table["line_name"] == "NeII_128136N")[0][0]
ir23128n2_narrow_ne3_idx = np.argwhere(ir23128n2_line_table["line_name"] == "NeIII_155551N")[0][0]
ir23128n2_broad_ne3_idx = np.argwhere(ir23128n2_line_table["line_name"] == "NeIII_155551B")[0][0]

ir23128n2_s4_flux = ir23128n2_line_table["line_strength_int"][ir23128n2_broad_s4_idx] + ir23128n2_line_table["line_strength_int"][ir23128n2_narrow_s4_idx]
ir23128n2_s4_flux_err = np.sqrt(ir23128n2_line_table["line_strength_int_unc"][ir23128n2_broad_s4_idx] ** 2 + ir23128n2_line_table["line_strength_int_unc"][ir23128n2_narrow_s4_idx] ** 2)
ir23128n2_ne2_flux = ir23128n2_line_table["line_strength_int"][ir23128n2_ne2_idx]
ir23128n2_ne2_flux_err = ir23128n2_line_table["line_strength_int_unc"][ir23128n2_ne2_idx]
ir23128n2_ne3_flux = ir23128n2_line_table["line_strength_int"][ir23128n2_broad_ne3_idx] + ir23128n2_line_table["line_strength_int"][ir23128n2_narrow_ne3_idx]
ir23128n2_ne3_flux_err = np.sqrt(ir23128n2_line_table["line_strength_int_unc"][ir23128n2_broad_ne3_idx] ** 2 + ir23128n2_line_table["line_strength_int_unc"][ir23128n2_narrow_ne3_idx] ** 2)

new_s4_fluxes = np.array([ir23128n0_s4_flux, ir23128n1_s4_flux, ir23128n2_s4_flux])
new_s4_flux_errs = np.array([ir23128n0_s4_flux_err, ir23128n1_s4_flux_err, ir23128n2_s4_flux_err])
new_ne2_fluxes = np.array([ir23128n0_ne2_flux, ir23128n1_ne2_flux, ir23128n2_ne2_flux])
new_ne2_flux_errs = np.array([ir23128n0_ne2_flux_err, ir23128n1_ne2_flux_err, ir23128n2_ne2_flux_err])
new_ne3_fluxes = np.array([ir23128n0_ne3_flux, ir23128n1_ne3_flux, ir23128n2_ne3_flux])
new_ne3_flux_errs = np.array([ir23128n0_ne3_flux_err, ir23128n1_ne3_flux_err, ir23128n2_ne3_flux_err])
